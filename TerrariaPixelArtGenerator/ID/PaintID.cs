namespace TerrariaPixelArtGenerator.ID;

internal class PaintID
{
    public static readonly string[] Names = typeof(PaintID).GetFields().Skip(1).Select(x => x.Name).ToArray();
